...
import dynamic from "next/dynamic"; // <-- NEW: for dynamic import
...
// Dynamically import IconCloud (no SSR to prevent hydration error)
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="flex items-center justify-center">
                    <div className="relative max-w-[32rem] overflow-hidden">
                        {/* IconCloud rendered here dynamically */}
