...
export default function Register() {
    ...
    return (
        <div className="pt-24 mx-auto w-full max-w-md rounded-none border border-solid border-white/30 bg-white p-4 shadow-input dark:bg-black md:rounded-2xl md:p-8">
            <h2 className="pt-24 text-xl font-bold text-neutral-800 dark:text-neutral-200">
